  ...
  const kpiCards = useMemo<KpiCard[]>(() => {
    const base: KpiCard[] = [
      ...
      },
      {
        ...
        delta: stats.cashBalanceDeltaPct ?? 0,
        tone: stats.cashBalance >= 0 ? "positive" : "negative",
        compareLabel: "vs. mes anterior",
        explanation: "Caja acumulada del negocio hasta hoy. Suma ingresos cobrados y descuenta egresos ya registrados.",
        tooltip: "Saldo en Caja = acumulado histórico de movimientos realizados hasta hoy. No replica la utilidad del mes: arrastra meses previos y muestra la liquidez acumulada registrada en el sistema.",
      },
      {
      ...
      {
        title: "Reembolsos pendientes del mes",
        value: stats.pendingReimbursements ?? null,
        delta: stats.pendingReimbursementsDeltaPct ?? 0,
        tone: "neutral",
        compareLabel: "vs. semana anterior",
        explanation: "Gastos del mes actual que siguen pendientes de reembolso al equipo.",
        tooltip: "Reembolsos pendientes del mes = gastos del período actual pagados por el equipo y todavía no reembolsados, más transacciones de gasto que siguen en estado pendiente.",
